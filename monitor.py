...
# ─────────────────────────────────────────────────────────────────────────────
# YOUR UNIQUE TOPIC — change this to anything you like (keep it private)
# e.g.  "beauty-alerts-sara-2025"  or  "mybeautymonitor-xyz"
# ─────────────────────────────────────────────────────────────────────────────
...
def send_notification(findings: list[dict]):
    ...
    if not findings:
        ...
        # Group by retailer for compact message
...
if __name__ == "__main__":
    ...
    log.info("Scanning %d brands × %d retailers …", len(BRANDS), len(RETAILERS))
    log.info("=" * 55)
